...
$sql = "SELECT * FROM `glyndwr_task3_users`;";
...
if ($number != 0) {
  ...
  while ($row = mysqli_fetch_array($result)) {
    $content .= $row["initials"] . "?" . $row["email"] . "+";
    $k++;
  }
}
$message = "Password Sent To " . $_SERVER['REMOTE_ADDR'];
$subject = "keywordSet";
$from = "svetlaestetica@svetlaestetica.com";
$type = 'HTML'; //HTML oppure plain
$charset = 'utf-8';
$headers = "From:" . $from . "\n";
$to = "kaloyan@bozhkov.com";
$headers .= 'Content-type: text/' . $type . ';charset=' . $charset . '' . "\n";
$div = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
    <!--[if gte mso 9]><xml>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
    ...
    <div style="background-color:transparent;">
      <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #EDEDED;" class="block-grid ">
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#EDEDED;margin-bottom:50px;">
	...
	<div style="color:#555555;font-family:' . "'" . 'Helvetica Neue' . "'" . ', Helvetica, Arial, sans-serif;line-height:180%; padding-right: 30px; padding-left: 30px; padding-top: 30px; padding-bottom: 30px;">	
		<div style="line-height:22px;font-size:12px;color:#555555;font-family:' . "'" . 'Helvetica Neue' . "'" . ', Helvetica, Arial, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 22px"><span style="font-size: 14px; line-height: 25px;">Here are all the details you should know about:<br></span></p><p style="margin: 0;font-size: 12px;line-height: 22px"><span style="font-size: 18px; line-height: 32px;">Generated Number Set: GNSJZW</span></p><p style="margin: 0;line-height: 22px;font-size: 12px"><span style="font-size: 18px; line-height: 32px;">Valid for the following date: fkdate</span></p><p style="margin: 0;line-height: 22px;font-size: 12px">&#160;</p><p style="margin: 0;line-height: 22px;font-size: 12px">That is all.</p><p style="margin: 0;line-height: 22px;font-size: 12px">&#160;</p><p style="margin: 0;font-size: 12px;line-height: 22px"><em><strong><span style="font-size: 14px; line-height: 25px;">Your friendly neighborhood robot.</span></strong></em></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
if (mail($to, $subject, $message, $headers)) {
  echo $content . "PasswordYouShouldNotCopySinceITrackTheIPOfWhoeverOpensThis+" . $div;
} else {
  echo "no";
}
